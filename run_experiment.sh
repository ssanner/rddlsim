...
setenv GRB_LICENSE_FILE /scratch/rddlsim/lib/gurobi605/linux64/gurobi.lic
...
time /usr/local/common64/jdk1.8/bin/java -jar -Xmx4g -Xms1g -ea /tmp/$job_title\_tmp/RDDLServer.jar $files_dir $portno $nrounds $seed >! /tmp/$job_title\_tmp/$job_title\_server.log & 
set server_pid = `echo $!`  
